...
<section className="py-32 bg-gradient-to-b from-background to-muted/30">
  ...
  <div className="max-w-4xl mx-auto px-6 space-y-12 text-center">
    ...
    <p className="text-lg text-muted-foreground leading-relaxed">
      Oferecemos um monitoramento integral e inteligente, capaz de identificar, 
      em tempo real, qualquer risco à identidade e reputação do seu negócio.
    </p>

    <div className="text-left">
      <p className="text-xl font-semibold mb-3">Nosso sistema avançado monitora:</p>
    ...
    <div className="pt-6">
      ...
      <p className="text-2xl font-bold mt-2 text-indigo-600">
        Identificamos → Notificamos → Atuamos → Defendemos sua marca
      </p>
    </div>
  </div>
</section>
  ...
  <div className="section-container">
    ...
    >
      <div className="inline-block mb-4 px-4 py-1 rounded-full bg-accent/10 border border-accent/20">
        <span className="text-accent font-semibold text-sm">NOSSA EQUIPE</span>
      </div>
      <h2 className="font-display text-4xl md:text-5xl">
        Os fundadores por trás da WAGR
      </h2>
      <p className="text-muted-foreground text-lg mt-4 max-w-2xl mx-auto">
        Profissionais que unem tecnologia, estratégia jurídica e visão de negócios.
      </p>
    </motion.div>
